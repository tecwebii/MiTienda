...
$consulta_usuario = "SELECT nombre_usuario, password_usuario, tipo_usuario, nickname FROM Usuarios WHERE nombre_usuario = '$usuario' AND password_usuario = '$password'";
